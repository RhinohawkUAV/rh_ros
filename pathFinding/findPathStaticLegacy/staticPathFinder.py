...
class StaticPathFinder(Drawable):
    ...
    def __init__(self, startPoint, goalPoint, obstacleCourse, drawListener=None):
        ...
        # This object is signalled, with a copy of pathFinding.findPathStaticLegacy, whenever it is time to draw
    ...
    def _createDrawCopy(self):
        """
        Creates a copy of the pathFinding.findPathStaticLegacy object for drawing.
